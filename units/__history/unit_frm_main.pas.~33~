...
type
  Tfrm_main = class(TForm)
    ...
    procedure compiler(Sender: TObject);
  private
...
uses unit_frm_teamManager, unit_frm_server, unit_frm_compiler;
             ...
             begin
               ...
               try
                 ...
                 try
                   ...
                   ini.WriteString('Status','sourceName','source.cpp');
                   ini.WriteString('Status','problemID','A');///////////BECCA //TODO:
                 finally
                  ini.Free;
                 end;
...
procedure Tfrm_main.compiler(Sender: TObject);
begin
  frm_compiler.ShowModal;
end;
